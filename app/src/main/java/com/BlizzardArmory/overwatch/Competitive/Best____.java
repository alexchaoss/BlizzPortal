...
public class Best____ {
    ...
    @SerializedName("weaponAccuracyBestInGame")
    @Expose
    private String weaponAccuracyBestInGame;
    ...
    public String getWeaponAccuracyBestInGame() {
        return weaponAccuracyBestInGame;
    }

    public void setWeaponAccuracyBestInGame(String weaponAccuracyBestInGame) {
        this.weaponAccuracyBestInGame = weaponAccuracyBestInGame;
    }
