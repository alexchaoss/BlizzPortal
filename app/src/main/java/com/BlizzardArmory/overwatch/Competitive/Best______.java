...
public class Best______ {
    ...
    @SerializedName("criticalHitsMostInGame")
    @Expose
    private int criticalHitsMostInGame;
    @SerializedName("criticalHitsMostInLife")
    @Expose
    private int criticalHitsMostInLife;
    @SerializedName("eliminationsMostInGame")
    @Expose
    private int eliminationsMostInGame;
    @SerializedName("eliminationsMostInLife")
    @Expose
    private int eliminationsMostInLife;
    ...
    public int getCriticalHitsMostInGame() {
        return criticalHitsMostInGame;
    }

    public void setCriticalHitsMostInGame(int criticalHitsMostInGame) {
        this.criticalHitsMostInGame = criticalHitsMostInGame;
    }

    public int getCriticalHitsMostInLife() {
        return criticalHitsMostInLife;
    }

    public void setCriticalHitsMostInLife(int criticalHitsMostInLife) {
        this.criticalHitsMostInLife = criticalHitsMostInLife;
    }
    ...
    public int getEliminationsMostInLife() {
        return eliminationsMostInLife;
    }

    public void setEliminationsMostInLife(int eliminationsMostInLife) {
        this.eliminationsMostInLife = eliminationsMostInLife;
    }
