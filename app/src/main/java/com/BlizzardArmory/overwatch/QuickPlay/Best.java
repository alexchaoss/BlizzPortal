...
public class Best {
    ...
    @Expose
    private int barrierDamageDoneMostInGame;
    ...
    @Expose
    private int environmentalKillsMostInGame;
    ...
    @Expose
    private int heroDamageDoneMostInGame;
    ...
    public int getBarrierDamageDoneMostInGame() {
        return barrierDamageDoneMostInGame;
    }

    public void setBarrierDamageDoneMostInGame(int barrierDamageDoneMostInGame) {
    ...
    public int getEnvironmentalKillsMostInGame() {
        return environmentalKillsMostInGame;
    }

    public void setEnvironmentalKillsMostInGame(int environmentalKillsMostInGame) {
    ...
    public int getHeroDamageDoneMostInGame() {
        return heroDamageDoneMostInGame;
    }

    public void setHeroDamageDoneMostInGame(int heroDamageDoneMostInGame) {
    ...
    public int getMultikillsBest() {
        return multikillsBest;
    }

    public void setMultikillsBest(int multikillsBest) {
    ...
    public int getReconAssistsMostInGame() {
        return reconAssistsMostInGame;
    }

    public void setReconAssistsMostInGame(int reconAssistsMostInGame) {
    ...
    public int getTeleporterPadsDestroyedMostInGame() {
        return teleporterPadsDestroyedMostInGame;
    }

    public void setTeleporterPadsDestroyedMostInGame(int teleporterPadsDestroyedMostInGame) {
