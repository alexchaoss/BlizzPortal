...
class OWLeagueViewModel(application: Application) : BaseViewModel(application) {
    ...
    val tempListPlayers = mutableListOf<Player>()
    val tempListHero = mutableListOf<Hero>()
    val tempListStats = mutableListOf<Stat>()
    ...
    var previousHero = ""
    var previousStatAmount = ""

    var teamCount = 0

    lateinit var tempTeam1: Team
    lateinit var tempTeam2: Team
