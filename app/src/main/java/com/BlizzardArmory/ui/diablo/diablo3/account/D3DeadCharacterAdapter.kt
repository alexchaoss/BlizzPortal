...
import com.BlizzardArmory.model.diablo.diablo3.account.FallenHero

class D3DeadCharacterAdapter(private val list: List<FallenHero>) : RecyclerView.Adapter<D3DeadCharacterViewHolder>() {
